...
sys.path.append("../src")
import parse  # pylint: disable=import-error,wrong-import-position
...
def test_parse_node_list():
    ...
    if parse.parse_node_list('n[1-3,05-07,9]') \
            == ['n1', 'n2', 'n3', 'n05', 'n06', 'n07', 'n9']:
        test.print_pass()
    else:
        test.print_fail()

    if parse.parse_node_list('n[1-3,05-07,9],airwolf') \
            == ['n1', 'n2', 'n3', 'n05', 'n06', 'n07', 'n9', 'airwolf']:
        test.print_pass()
    else:
        test.print_fail()
